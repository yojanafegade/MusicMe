  ...
  return (
    <div className="h-[620px]">
      ...
      <div className="flex justify-between gap-3 mt-5">
        ...
        />
        <button
          className="bg-violet-600 rounded-lg hover:bg-violet-800 text-white py-2 px-5"
          onClick={() => {
            if (selectedPlaylistForEdit) {
              onEdit();
            } else {
      ...
      <div className="grid grid-cols-3 gap-3">
        {allSongs.map((song, index) => {
          ...
          return (
            <div
              className={`p-4 flex items-center shadow justify-between border text-white playergradient cursor-pointer rounded ${
