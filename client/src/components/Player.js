...
import songimg1 from "../images/songimg1r.png";
...
function Player() {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 p-5 shadow-lg text-white">
      <div className="flex justify-between items-center border p-5 border-violet-400 rounded-2xl shadow-xl playergradient">
        <div className="flex items-center gap-2 w-96">
          ...
          />
          <div>
            <h1 className="text-violet-400 text-2xl">{currentSong?.title}</h1>
        ...
        <div className="w-96 flex flex-col items-center text-white">
          <audio
            src={currentSong?.src}
            ref={audioRef}
            onTimeUpdate={(e) => {
          ...
          <div className="flex gap-3 items-center w-full">
            <i
              className={`ri-shuffle-line text-xl ${
                shuffleOn && "text-violet-400 font-semibold"
              }`}
              onClick={() => {
